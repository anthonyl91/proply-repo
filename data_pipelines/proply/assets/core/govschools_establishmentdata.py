...
def fetch_govschools_establishmentdata_from_url(
    ...
    return {
        ...
        "schema": {
            ...
            "type_of_establishment_code": "TEXT",
            "type_of_establishment_name": "TEXT",
            "establishment_type_group_code": "TEXT",
            "establishment_type_group_name": "TEXT",
            "establishment_status_code": "TEXT",
            "establishment_status_name": "TEXT",
            "reason_establishment_opened_code": "TEXT",
            "reason_establishment_opened_name": "TEXT",
            "open_date": "TEXT",
            "reason_establishment_closed_code": "TEXT",
            "reason_establishment_closed_name": "TEXT",
            "close_date": "TEXT",
            "phase_of_education_code": "TEXT",
            "phase_of_education_name": "TEXT",
            "statutory_low_age": "TEXT",
            "statutory_high_age": "TEXT",
            "boarders_code": "TEXT",
            "boarders_name": "TEXT",
            "nursery_provision_name": "TEXT",
            "official_sixth_form_code": "TEXT",
            "official_sixth_form_name": "TEXT",
            "gender_code": "TEXT",
            "gender_name": "TEXT",
            "religious_character_code": "TEXT",
            "religious_character_name": "TEXT",
            "religious_ethos_name": "TEXT",
            "diocese_code": "TEXT",
            "diocese_name": "TEXT",
            "admissions_policy_code": "TEXT",
            "admissions_policy_name": "TEXT",
            "school_capacity": "TEXT",
            "special_classes_code": "TEXT",
            "special_classes_name": "TEXT",
            "census_date": "TEXT",
            "number_of_pupils": "TEXT",
            "number_of_boys": "TEXT",
            "number_of_girls": "TEXT",
            "percentage_fsm": "TEXT",
            "street": "TEXT",
            "locality": "TEXT",
            "address3": "TEXT",
